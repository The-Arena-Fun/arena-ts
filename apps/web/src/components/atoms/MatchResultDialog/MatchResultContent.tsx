    ...
    <div className="max-w-xl flex flex-1 flex-col gap-y-4 flex-grow-0">
      ...
      <div className="rounded-lg border border-[#28323C] flex flex-1 flex-col gap-y-4">
        <div className="flex flex-row items-center justify-center gap-x-4 py-4 px-12 pt-6">
          ...
          <MatchResultOpponent
            winner
            image={meQuery.data?.pubkey === "GmmK8Yh7LWCHLnMzqNt7yLz17cX7JfrP7bXppHquXrDY" ? "https://pbs.twimg.com/profile_images/1740125899163328512/Z_lShBa6_400x400.jpg" : "https://pbs.twimg.com/profile_images/1776337353306415104/3aICr3qw_400x400.png"} />
        </div>
